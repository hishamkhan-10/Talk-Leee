            ...
            {open ? (
                <div className="fixed inset-0 z-50">
                    ...
                    <motion.div
                        ...
                        className={cn(
                            "absolute left-1/2 top-1/2 w-[calc(100%-24px)] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-2xl border border-white/15 bg-gray-950/85 text-white shadow-2xl outline-none backdrop-blur-xl",
                            sizeClass
                        )}
