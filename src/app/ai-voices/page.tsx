...
export default function AiVoicesPage() {
  ...
  const handlePreview = (voiceId: string) => {
    if (playingId === voiceId) {
      ...
      console.log(`Stopped playing ${voiceId}`);
    } else {
  ...
  return (
    <main className="min-h-screen bg-white home-navbar-offset">
      <Navbar />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {voices.map((voice, index) => (
              <motion.div
                ...
                className="group p-8 rounded-2xl border border-gray-100 bg-white hover:border-gray-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col items-center text-center"
              >
