...
test("dashboard layout includes theme toggle and removes global sidebar toggle", () => {
    ...
    assert.match(contents, /Switch to (dark|light) theme/);
    assert.match(contents, /toggleTheme/);
